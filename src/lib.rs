...
#[repr(C)] pub struct internal_state;
...
extern "system" {
  ...
  pub fn deflateInit2 (strm: z_streamp, level: c_int, method: c_int, windowBits: c_int, memLevel: c_int, strategy: c_int) -> c_int;
  pub fn deflateParams (strm: z_streamp, level: c_int, strategy: c_int) -> c_int;
  pub fn deflatePending (strm: z_streamp, pending: *mut libc::c_uint, bits: *mut c_int) -> c_int;
  ...
  pub fn inflateBackInit (strm: z_streamp, windowBits: c_int, window: *mut c_uchar) -> c_int;
